...
/**
 * The window of "With Lines" option.
 */
public final class LineOptionWindow {
	...
	private final class ConfigurationReflector implements Runnable {
		...
		private void setEnglishTexts() {
			frame.setTitle("Option Settings: With Lines");
